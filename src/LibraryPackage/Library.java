...
public class Library {
   ...
   Book book= new Book("Love and Thunder","Jordan", 10);

   Visitor visitor = new Visitor("Mick","LamX@gamil.com");
        Borrowing borrowing = new Borrowing("King Jerico","Jack","2023_12_13");
