...
public class Library {
   ...
   Book book= new Book("Love and Thunder","John", 10);

   Visitor visitor = new Visitor("John","LamX@gamil.com");
        Borrowing borrowing = new Borrowing("Animal Kingdom","Nick","2023_12_13");
